...
최종 출력: 3`,
  traceSteps: [
    ...
    },
    {
      ...
      variables: [{ name: "lst", type: "list", value: [1, 2, 3, 4, 5, 6] }],
    ...
    },
    {
      ...
      relatedLines: [{ line: 6, role: "call", label: "func 호출" }],
      memory: {
        cells: [
          {
            id: "data_lst",
    ...
    },
    {
      ...
      variables: [
        { name: "lst", type: "list", value: [1, 2, 3, 4, 5, 6] },
        { name: "i", type: "int", value: 0, highlight: true },
      ],
      relatedLines: [{ line: 5, role: "read", label: "lst 선언" }],
      memory: {
        cells: [
          {
            id: "data_lst",
    ...
    },
    {
      ...
      relatedLines: [{ line: 2, role: "read", label: "for 루프" }],
      memory: {
        cells: [
          {
            id: "data_lst",
    ...
    },
    {
      ...
      comment: "다음 반복 i=1",
      variables: [
        { name: "lst", type: "list", value: [6, 2, 3, 4, 5, 1] },
    ...
    },
    {
      ...
      comment: "다음 반복 i=2",
      variables: [
        { name: "lst", type: "list", value: [6, 5, 3, 4, 2, 1] },
    ...
    },
    {
      ...
      variables: [{ name: "lst", type: "list", value: [6, 5, 4, 3, 2, 1], highlight: true }],
      relatedLines: [{ line: 6, role: "call", label: "func 호출 위치" }],
    },
    {
      line: 7,
      comment: "sum(lst[::2]) — 짝수 인덱스 [6, 4, 2]의 합은 12입니다.",
      variables: [
        { name: "lst", type: "list", value: [6, 5, 4, 3, 2, 1] },
        { name: "sum(lst[::2])", type: "int", value: 12, highlight: true },
      ],
      relatedLines: [{ line: 5, role: "read", label: "lst 선언" }],
      memory: {
        cells: [
    ...
    },
    {
      ...
      variables: [
        { name: "lst", type: "list", value: [6, 5, 4, 3, 2, 1] },
        { name: "sum(lst[1::2])", type: "int", value: 9, highlight: true },
      ],
      relatedLines: [{ line: 5, role: "read", label: "lst 선언" }],
      memory: {
        cells: [
    ...
    },
    {
      ...
      variables: [{ name: "결과", type: "int", value: 3, highlight: true }],
      stdout: "3",
      relatedLines: [
        { line: 5, role: "read", label: "lst 선언" },
        { line: 1, role: "definition", label: "func 정의" },
      ],
      memory: {
        cells: [
